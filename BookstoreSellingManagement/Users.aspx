...
<asp:Content ID="Content2" ContentPlaceHolderID="phMain" runat="server">
    <div class="container-fluid">
        ...
        <!-- end page title -->
         ...
         <asp:UpdatePanel ID="Up_users" runat="server" class="row">
            <ContentTemplate>
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-editable table-nowrap align-middle table-edits">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="Rpt_BooksList" runat="server" ItemType="BookstoreManagementDAL.TblUser">
                                            <ItemTemplate>
                                                <tr>
                                                    <td><%# Container.ItemIndex + 1 %></td>
                                                    <td><%# CutString(Item.FirstName) %></td>
                                                    <td><%# CutString(Item.LastName) %></td>

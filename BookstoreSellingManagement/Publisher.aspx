...
<asp:Content ID="Content2" ContentPlaceHolderID="phMain" runat="server">
    <div class="container-fluid">
        ...
        <!-- end page title -->
         ...
         <asp:UpdatePanel ID="Up_publishers" runat="server" class="row">
            <ContentTemplate>
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-editable table-nowrap align-middle table-edits">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="Rpt_List" runat="server" ItemType="BookstoreManagementDAL.TblPublisher">
                                            <ItemTemplate>
                                                <tr>
                                                    <td data-field="number"><%# Container.ItemIndex + 1 %></td>
                                                    <td data-field="name"><%# CutString(Item.Name) %></td>
                                                    <td data-field="address"><%# CutString(Item.Address) %></td>
